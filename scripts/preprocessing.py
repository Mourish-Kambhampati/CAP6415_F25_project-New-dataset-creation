...
# Since you already ran: cd CAP6415_F25_project-New-dataset-creation
...
# Load lion + tiger samples
pairs = []
pairs += load_pairs("dataset_images/lion/images",  "dataset_labels/lion/labels")
pairs += load_pairs("dataset_images/tiger/images", "dataset_labels/tiger/labels")
